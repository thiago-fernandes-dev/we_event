 ...
 return(
  <form onSubmit={handleSubmit} className=" bg-white rouded-xl shadow-lg flex flex-col gap-3 p-8 mt-10 mx-auto max-w-xl " >
    ...
    <h2 className="text-center">Cadastro de Usuário</h2>
      ...
      <button type="button" className=" bg-gray-800  text-white border rounded-2xl p-2 self-center w-60 mt-2 hover:bg-gray-700  transition-colors cursor-pointer">Possui conta? Clique aqui!</button>
    </form>
